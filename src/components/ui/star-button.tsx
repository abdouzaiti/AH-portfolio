...
interface StarButtonProps extends React.ComponentPropsWithoutRef<"button"> {
...
export function StarButton({
    ...
    const updatePath = () => {
      if (pathRef.current) {
        ...
        button.style.setProperty(
          "--path",
          `path('M 0 0 H ${button.offsetWidth} V ${button.offsetHeight} H 0 V 0')`,
        );
      }
    };
  ...
  return (
    ...
    >
      ...
      <span className="z-10 relative text-white font-bold flex items-center gap-2">
        {children}
      </span>
    </button>
  );
